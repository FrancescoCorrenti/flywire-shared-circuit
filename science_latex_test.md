...
*Figure 1: Top 50 cell types by neuron count, coloured by class. The distribution is right-skewed (median 1, mean 6.7). Columnar ${\color[RGB]{68,119,170}\text{OL}}$ neurons dominate, with KCs (${\color[RGB]{238,102,119}\text{KCab}}$, ${\color[RGB]{238,102,119}\text{KCg-m}}$) as the only non-${\color[RGB]{68,119,170}\text{OL}}$ types in the top 50.*
